...
module s7_slot1_issue_packet_tb;
    logic clk;
    logic rst_n;
    integer checks;
    integer failures;
    ...
    task automatic drive_payload(input logic valid, input logic issue_valid);
        begin
            slot1_pc = 32'h1c00_4004;
            instr1 = 32'h0280_10a9;
            slot1_valid = valid;
            slot1_opcode = 7'h31;
            slot1_funct3 = 3'h5;
            slot1_funct7 = 7'h22;
            slot1_op_19_15 = 5'h09;
            slot1_rs1 = 5'd9;
            slot1_rs2 = 5'd10;
            slot1_rd = 5'd11;
            slot1_imm = 32'h0000_0024;
            ...
            slot1_src_b_sel = 2'd0;
            slot1_alu_op = 4'h1;
            slot1_rs1_val = 32'haaaa_0009;
            slot1_rs2_val = 32'hbbbb_000a;
            slot1_op_a = 32'h1234_0009;
            slot1_op_b = 32'h5678_000a;
    ...
    initial begin
        ...
        #1;
        `check32("PKT invalid still passes pc for debug", slot1_pc_o, 32'h1c00_4004);
        `check32("PKT invalid still passes instr for debug", instr1_o, 32'h0280_10a9);
        ...
        `check32("PKT invalid clears op A", slot1_op_a_o, 32'd0);
        `check32("PKT invalid clears op B", slot1_op_b_o, 32'd0);
        ...
        `check("PKT valid keeps writeback and source usage",
               slot1_wb_en_o && slot1_uses_rs1_o && slot1_uses_rs2_o);
        `check32("PKT valid opcode", {25'd0, slot1_opcode_o}, {25'd0, 7'h31});
        `check32("PKT valid funct bundle", {17'd0, slot1_funct3_o, slot1_funct7_o, slot1_op_19_15_o}, {17'd0, 3'h5, 7'h22, 5'h09});
        `check32("PKT valid registers", {17'd0, slot1_rs1_o, slot1_rs2_o, slot1_rd_o}, {17'd0, 5'd9, 5'd10, 5'd11});
        `check32("PKT valid imm", slot1_imm_o, 32'h0000_0024);
        `check32("PKT valid rs1 value", slot1_rs1_val_o, 32'haaaa_0009);
        `check32("PKT valid rs2 value", slot1_rs2_val_o, 32'hbbbb_000a);
        `check32("PKT valid op A", slot1_op_a_o, 32'h1234_0009);
        `check32("PKT valid op B", slot1_op_b_o, 32'h5678_000a);
