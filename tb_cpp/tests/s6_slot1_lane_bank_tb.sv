...
module s6_slot1_lane_bank_tb;
    ...
    logic        raw_slot1_valid_o;
    logic        raw_slot1_issue_valid_o;
    logic [3:0]  raw_slot1_issue_class_o;
    logic        raw_slot1_wb_en_o;
    logic        raw_slot1_is_load_o;
    logic        raw_slot1_is_store_o;
    logic        raw_slot1_uses_rs1_o;
    logic        raw_slot1_uses_rs2_o;
    logic [4:0]  raw_slot1_rs1_o;
    logic [4:0]  raw_slot1_rs2_o;
    logic [4:0]  raw_slot1_rd_o;
    ...
    s6_slot1_lane_bank u_dut (
        ...
        .raw_slot1_valid_o(raw_slot1_valid_o),
        .raw_slot1_issue_valid_o(raw_slot1_issue_valid_o),
        .raw_slot1_issue_class_o(raw_slot1_issue_class_o),
        .raw_slot1_wb_en_o(raw_slot1_wb_en_o),
        .raw_slot1_is_load_o(raw_slot1_is_load_o),
        .raw_slot1_is_store_o(raw_slot1_is_store_o),
        .raw_slot1_uses_rs1_o(raw_slot1_uses_rs1_o),
        .raw_slot1_uses_rs2_o(raw_slot1_uses_rs2_o),
        .raw_slot1_rs1_o(raw_slot1_rs1_o),
        .raw_slot1_rs2_o(raw_slot1_rs2_o),
        .raw_slot1_rd_o(raw_slot1_rd_o),
    ...
    task automatic drive_payload;
        input [31:0] base;
        input        valid;
        input        issue_valid_in;
        input [3:0]  issue_class_in;
        begin
            slot1_pc = base;
            ...
            slot1_issue_valid = issue_valid_in;
            slot1_issue_class = issue_class_in;
        end
    endtask
    ...
    initial begin
        ...
        rst_n = 1'b1;
        capture = 1'b0;
        drive_payload(32'h1c00_6004, 1'b1, 1'b1, 4'b1010);

        capture = 1'b1;
        tick();
        #1;
        `check("S6S1BANK raw valid capture", raw_slot1_valid_o);
        `check("S6S1BANK raw issue valid capture", raw_slot1_issue_valid_o);
        `check32("S6S1BANK raw issue class capture",
                 {28'd0, raw_slot1_issue_class_o}, {28'd0, 4'b1010});
        `check32("S6S1BANK raw regs capture",
                 {17'd0, raw_slot1_rs1_o, raw_slot1_rs2_o, raw_slot1_rd_o},
                 {17'd0, 5'd4, 5'd0, 5'd24});
        `check("S6S1BANK packet valid capture", slot1_valid_o && slot1_issue_valid_o);
        `check32("S6S1BANK packet class capture",
                 {28'd0, slot1_issue_class_o}, {28'd0, 4'b1010});
        `check32("S6S1BANK packet rs1 value capture", slot1_rs1_val_o, 32'h2c00_6005);

        capture = 1'b0;
        drive_payload(32'h1c00_9008, 1'b0, 1'b1, 4'b0100);
        #1;
        `check("S6S1BANK hold raw valid when capture low", raw_slot1_valid_o);
        `check("S6S1BANK hold packet valid when capture low", slot1_valid_o && slot1_issue_valid_o);

        capture = 1'b1;
        tick();
        #1;
        `check("S6S1BANK invalid capture keeps raw issue sideband",
               !raw_slot1_valid_o && raw_slot1_issue_valid_o);
        `check32("S6S1BANK invalid capture keeps raw class",
                 {28'd0, raw_slot1_issue_class_o}, {28'd0, 4'b0100});
        `check("S6S1BANK invalid capture clears packet issue sideband",
               !slot1_valid_o && !slot1_issue_valid_o);
        `check32("S6S1BANK invalid capture clears packet class",
                 {28'd0, slot1_issue_class_o}, 32'd0);
        `check32("S6S1BANK invalid capture clears packet rs1",
                 {27'd0, slot1_rs1_o}, 32'd0);
        `check32("S6S1BANK invalid capture keeps raw rs1",
                 {27'd0, raw_slot1_rs1_o}, {27'd0, 5'd8});
