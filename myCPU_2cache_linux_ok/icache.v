module icache(
    ...
    localparam main_write_back   = 7'b0000100;
    localparam main_replace      = 7'b0001000;
    localparam main_refill       = 7'b0010000;
    localparam main_write        = 7'b0100000;
...
`define Data   127:0
    ...
    wire [3:0]   way_wr_en;    // 1000、0100、0010、0001
    wire [31:0]  write_in;
    ...
    // 如果 uncache 访存
    assign data_ok = request_buffer_uncache_en ? main_state_is_refill && ret_valid && ret_last : (main_state_is_lookup && cache_hit) || (main_state_is_retry && cache_hit);
    ...
    initial begin
        ...
        for (i = 0; i < 4; i = i + 1) begin
            main_refill_data_buffer[i] = 32'd0;
        end
    end
