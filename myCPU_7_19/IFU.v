...
//                 ifu_state <= waite_data_ok == 2'b01 ? 2'd1 : 2'd2;
//             end
//         end
//         // 给下游准备数据阶段
//         else if(ifu_state == 2'd2) begin
//             if(data_ok) begin
//                 ifu_state <= waite_data_ok == 2'b01 ? 2'd1 : 2'd0;
//             end
//         end
//     end

//     // 这里设置一个辅助状态机，遇到 flush 一定要取两次指令，并抛弃第二次的，当然
//     // 当然如果实现了 icache，就可以直接发射 cancel 信号
//     reg [1:0] waite_data_ok;
//     always @(posedge clk) begin
//         if(rst) begin
//             waite_data_ok <= 2'b00;
//         end
//         else if(waite_data_ok == 2'b00) begin
//             if(flush_sign) begin
//                 waite_data_ok <= 2'b01;
//             end
//         end
//         // 如果等到 data_ok，抛弃这个结果
//         else if(waite_data_ok == 2'b01) begin
//             waite_data_ok <= data_ok ? 2'b10 : 2'b01;

//         end
//         // 获取第二个结果
//         else if(waite_data_ok == 2'b10) begin
//             waite_data_ok <= data_ok ? 2'b00 : 2'b10;
//         end
//     end
...
//     assign rdata_o = rdata;
//     assign waite_ready_o = idle_flush ? 1'b0: (ifu_state == 2'd0);
//     assign state_valid = ifu_state == 2'd2 && data_ok && waite_data_ok != 2'b01;
