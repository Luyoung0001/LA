...
# 800 "start.S"
test_end:
    lu12i.w $r23 , ((((1*20 + 1*16 + 1*10 + 1*1 + 1*11 + 0*12 + 0*2 + 0*7 + 0*2)>>12)+(((1*20 + 1*16 + 1*10 + 1*1 + 1*11 + 0*12 + 0*2 + 0*7 + 0*2)&0x00000800)>>11))&0x000fffff)&0x80000?((((1*20 + 1*16 + 1*10 + 1*1 + 1*11 + 0*12 + 0*2 + 0*7 + 0*2)>>12)+(((1*20 + 1*16 + 1*10 + 1*1 + 1*11 + 0*12 + 0*2 + 0*7 + 0*2)&0x00000800)>>11))&0x000fffff)-0x100000:((((1*20 + 1*16 + 1*10 + 1*1 + 1*11 + 0*12 + 0*2 + 0*7 + 0*2)>>12)+(((1*20 + 1*16 + 1*10 + 1*1 + 1*11 + 0*12 + 0*2 + 0*7 + 0*2)&0x00000800)>>11))&0x000fffff); ;;;; addi.w $r23, $r23, ((1*20 + 1*16 + 1*10 + 1*1 + 1*11 + 0*12 + 0*2 + 0*7 + 0*2) & 0x00000fff)&0x800?((1*20 + 1*16 + 1*10 + 1*1 + 1*11 + 0*12 + 0*2 + 0*7 + 0*2) & 0x00000fff)-0x1000:((1*20 + 1*16 + 1*10 + 1*1 + 1*11 + 0*12 + 0*2 + 0*7 + 0*2) & 0x00000fff)
    ;;;
    beq $r23, $r26, 1f
    ;;;
