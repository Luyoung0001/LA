...
//         arvalid <=
//                 handling_inst_request && inst_state == READ_ADDR && !arready ||
//                 handling_data_request && data_state == READ_ADDR && !arready ? 1'b1:1'b0;
//         arid <= handling_data_request && data_state == READ_ADDR ? 4'b0001 : 4'b0000;

//         araddr <= handling_inst_request && inst_state == READ_ADDR ? inst_sram_addr :
//                handling_data_request && data_state == READ_ADDR ? data_sram_addr :
//                inst_sram_addr;

//         arsize <= handling_data_request ? convert_size(data_sram_size) : convert_size(inst_sram_size);
//         arlen <= 8'b00000000;
//         rready <=
//                handling_inst_request && inst_state == READ_ADDR && arready ||
//                handling_data_request && data_state == READ_ADDR && arready ? 1'b1: 1'b0;
