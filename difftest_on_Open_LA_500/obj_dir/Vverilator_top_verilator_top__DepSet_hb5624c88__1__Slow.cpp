...
VL_ATTR_COLD void Vverilator_top_verilator_top___ctor_var_reset(Vverilator_top_verilator_top* vlSelf) {
    ...
    vlSelf->debug_wb_is_csr_wr_o = VL_RAND_RESET_I(1);
    ...
    vlSelf->__PVT__cpu__DOT__exe_stage__DOT__is_csr_wr_i_r = VL_RAND_RESET_I(1);
    ...
    vlSelf->__PVT__cpu__DOT__mem_stage__DOT__is_csr_wr_i_r = VL_RAND_RESET_I(1);
    ...
    vlSelf->__PVT__cpu__DOT__wb_stage__DOT__is_csr_wr_i_r = VL_RAND_RESET_I(1);
