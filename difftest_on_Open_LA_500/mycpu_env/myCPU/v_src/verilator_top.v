module verilator_top(
    ...
    wire [31:0] csr_ectl_diff/* verilator public */;
    ...
    core_top cpu(
                 ...
                 .bid            (wire_bid),
                 // Deprecated / Unused?
                 .break_point    (1'b0          ),      // Tied low
                 .infor_flag     (1'b0          ),      // Tied low
                 .reg_num        (5'b0          ),      // Tied low
                 .ws_valid       (              ),      // <-- NOTE: Empty connection
                 .rf_rdata       (              ),      // <-- NOTE: Empty connection

                 // Debug Signals (Write-back Stage Info)
                 ...
                 .debug0_wb_is_csr_wr_o(debug_wb_is_csr_wr_o),
