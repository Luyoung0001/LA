module minicpu_top(
    ...
    assign gr_we         = inst_add_w | inst_ld_w | inst_addi_w; // 修改寄存器的值
    assign mem_we        = inst_st_w;   // 修改内存
    assign src_reg_is_rd = inst_bne | inst_st_w;    // 源寄存器来自 rd
